...
class Syntax(JupyterMixin):
    ...
    def guess_lexer(cls, path: str, code: Optional[str] = None) -> str:
        ...
        best lexer to use. For example, if the file is ``bukanindex.html`` and the file contains Django
        templating syntax, then "html+django" will be returned. If the file is ``bukanindex.html``, and no
