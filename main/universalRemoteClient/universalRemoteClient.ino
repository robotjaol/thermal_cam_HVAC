...
void loop() {
  ...
  delay(100); // Tambahkan delay di loop utama untuk mengurangi frekuensi eksekusi
}
...
void transmitIR() {
  if (client.connected() && client.available()) {
    ...
    if (message == "1") {
      ...
      client.println("respon 1 diterima");
      delay(2000);  
    } else if (message == "2") {
      Serial.println(message + "\n");
      client.println("respon 2 diterima");
      delay(2000);  
    } else if (message == "3") {
      Serial.println(message + "\n");
      client.println("respon 3 diterima");
      delay(2000);  
    } else if (message == "4") {
      Serial.println(message + "\n");
      client.println("respon 4 diterima");
      delay(2000);  
    } else {
      Serial.println("Pesan tidak valid");
      client.println("respon tidak valid diterima");
      delay(2000);  
    }
...
// // FUNCTION TES # Tambahkan delay setelah menerima responsTRANSMISI SIMPLE CONTROL LED > void loop
// void serverLed(){
//   if (client.connected()) {
//     if (client.available()) {
//       String message = client.readStringUntil('\n');
